...
try:
    ...
    print("   python test_M1.py  <k_g1> <k_s> <k_g2> <k_m>  <D>  <a> <no_of_simulations> <duration_of_simulation> \n")
    exit()
...
def run_sim (run_id):
    ...
    with open (f"simulations/model_active_k_{k}_D_{D}_a_{a}_run_{run_id}_sim-duration_{duration}.pkl", "wb") as file:
